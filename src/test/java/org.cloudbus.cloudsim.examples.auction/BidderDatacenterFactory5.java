 ...
 * Created on 2011/9/9
 */
public class BidderDatacenterFactory5 {
	...
	static BidderDatacenter createDatacenter3() {
	...
	static BidderDatacenter createDatacenter4() {
	...
	static BidderDatacenter createDatacenter5() {
	...
	static BidderDatacenter createDatacenter6() {
		String datacenterName = "Datacenter_6";
		...
		//4. Create Hosts with its id and list of PEs and add them to the list of machines
		int hostId=0;
		int ram = 8704; //host memory (MB)
		long storage = 47000; //host storage
		int bw = 3600;
		...
		bid.addVM(new DatacenterAbstractVm(300, 1,256, 150, 2000,
				new VmCharacteristics(arch, os, vmm, time_zone, 3.5, 0.05, 0.08, 0.5)), 2);
		bid.addVM(new DatacenterAbstractVm(400, 1, 512, 300, 4000,
				new VmCharacteristics(arch, os, vmm, time_zone, 3, 0.05, 0.08, 0.8)),  2);
		bid.addVM(new DatacenterAbstractVm(500, 1, 1024, 500, 5000,
				new VmCharacteristics(arch, os, vmm, time_zone, 2.8, 0.07, 0.09, 0.1)),  3);
		bid.addVM(new DatacenterAbstractVm(1000, 1, 2048, 600, 10000,
				new VmCharacteristics(arch, os, vmm, time_zone, 2.5, 0.05, 0.05, 0.05)),  2);

		datacenter.submitBid(bid);
		return datacenter;
	}

	static BidderDatacenter createDatacenter7() {
		String datacenterName = "Datacenter_7";
		...
		int hostId=0;
		int ram = 6144; //host memory (MB)
		long storage = 36000; //host storage
		int bw = 3200;
		...
		bid.addVM(new DatacenterAbstractVm(250, 1,256, 150, 2000,
				new VmCharacteristics(arch, os, vmm, time_zone, 2.5, 0.01, 0.04, 0.1)), 2);
		bid.addVM(new DatacenterAbstractVm(400, 1, 512, 300, 4000,
				new VmCharacteristics(arch, os, vmm, time_zone, 2.3, 0.01, 0.04, 0.1)),  3);
		bid.addVM(new DatacenterAbstractVm(500, 1, 1024, 500, 5000,
				new VmCharacteristics(arch, os, vmm, time_zone, 2.2, 0.01, 0.01, 0.1)),  4);
//		bid.addVM(new DatacenterAbstractVm(1000, 1, 2048, 600, 10000,
//				new VmCharacteristics(arch, os, vmm, time_zone, 2, 0.01, 0.01, 0.05)),  2);
